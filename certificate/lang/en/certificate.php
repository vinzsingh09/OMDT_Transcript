...
// Strings added for FSTE OMDT
$string['typefste_omdt'] = 'FSTE OMDT';
$string['title_distinction'] = 'Certificate of Distinction';
$string['title_credit'] = 'Certificate of Credit';
$string['title_pass'] = 'Certificate of Pass';
$string['title_participation'] = 'Certificate of Participation';
$string['title_completion'] = 'Certificate of Completion';
$string['fste'] = 'FACULTY OF SCIENCE, TECHNOLOGY AND ENVIRONMENT';
$string['person'] = 'Dr. Bibhya Sharma';
$string['person_title'] = 'Associate Dean L&T';
$string['statement-success'] = 'has successfully completed the course';
